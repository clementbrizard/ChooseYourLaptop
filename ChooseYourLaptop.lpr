;; -*- lisp-version: "10.1 [32-bit Linux (x86)] (Mar 15, 2017 20:03)"; -*-

(in-package :cg-user)

(define-project :name :|ChooseYourLaptop|
  :modules (list (make-instance 'module :name "index")
                 (make-instance 'module :name "regles_faits")
                 (make-instance 'module :name "interface"))
  :projects nil
  :libraries nil
  :editable-files nil
